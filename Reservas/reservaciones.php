...
function formatearTelefono(input) {
  ...
  const calendar = new FullCalendar.Calendar(calendarEl, {
    ...
    events: reservas.map(r => ({
      ...
      display: 'background',
      color: '#ff000080' // 🔴 Rojo semitransparente
    })),
    ...
    select: function(info) {
      ...
      if (fechaInicio < hoy) {
        Swal.fire({
          ...
          text: 'No puedes reservar días que ya pasaron.',
      ...
      // 🚫 Validar si se cruza con reservas existentes
      for (const r of reservas) {
        ...
        if (fechaInicio < finR && fechaFin >= inicioR) {
          Swal.fire({
            ...
            text: 'Las fechas seleccionadas incluyen días ya reservados.',
